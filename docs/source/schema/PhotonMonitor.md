...
URI: [laura:PhotonMonitor](https://w3id.org/laura/PhotonMonitor)
 ...
 classDiagram
    ...
    click PhotonMonitor href "../PhotonMonitor/"
      ...
      PhotonMonitor : controls
        ...
        PhotonMonitor --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      PhotonMonitor : diagnostic
      ...
      PhotonMonitor : downstream
        
          
    
        
        
        PhotonMonitor --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      PhotonMonitor : electrical
        
          
    
        
        
        PhotonMonitor --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      PhotonMonitor : hardware_class
        
          
    
        
        
        PhotonMonitor --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      PhotonMonitor : hardware_model
        
      PhotonMonitor : hardware_type
        
      PhotonMonitor : inherits_from
        
      PhotonMonitor : inputs
      ...
      PhotonMonitor : machine_area
        
      PhotonMonitor : manufacturer
        
          
    
        
        
        PhotonMonitor --> "0..1" ManufacturerElement : manufacturer
      ...
      PhotonMonitor : outputs
        
          
    
        
        
        PhotonMonitor --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      PhotonMonitor : physical
        
          
    
        
        
        PhotonMonitor --> "0..1" PhysicalElement : physical
        click PhysicalElement href "../PhysicalElement/"
    

        
      PhotonMonitor : reference
        
          
    
        
        
        PhotonMonitor --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      PhotonMonitor : simulation
        
          
    
        
        
        PhotonMonitor --> "0..1" DiagnosticSimulationElement : simulation
        click DiagnosticSimulationElement href "../DiagnosticSimulationElement/"
    

        
      PhotonMonitor : subelement
        
      PhotonMonitor : upstream
        
          
    
        
        
        PhotonMonitor --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      PhotonMonitor : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:PhotonMonitor](https://w3id.org/laura/PhotonMonitor) |
...
| ---  | ---  |
| self | laura:PhotonMonitor |
| native | laura:PhotonMonitor |
