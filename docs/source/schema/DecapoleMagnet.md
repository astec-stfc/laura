# Class: DecapoleMagnet 


_Decapole magnet field, principal multipole order 4._
...
URI: [laura:DecapoleMagnet](https://w3id.org/laura/DecapoleMagnet)
...
```mermaid
 classDiagram
    class DecapoleMagnet
    click DecapoleMagnet href "../DecapoleMagnet/"
      MagneticElement <|-- DecapoleMagnet
        click MagneticElement href "../MagneticElement/"
      
      DecapoleMagnet : angle
        
      DecapoleMagnet : bore
        
      DecapoleMagnet : edge_field_integral
        
      DecapoleMagnet : entrance_edge_angle
        
      DecapoleMagnet : exit_edge_angle
        
      DecapoleMagnet : field_integral_coefficients
        
          
    
        
        
        DecapoleMagnet --> "0..1" FieldIntegral : field_integral_coefficients
        click FieldIntegral href "../FieldIntegral/"
    

        
      DecapoleMagnet : fringe_field_coefficient
        
      DecapoleMagnet : gap
        
      DecapoleMagnet : gradient
        
      DecapoleMagnet : length
        
      DecapoleMagnet : linear_saturation_coefficients
        
          
    
        
        
        DecapoleMagnet --> "0..1" LinearSaturationFit : linear_saturation_coefficients
        click LinearSaturationFit href "../LinearSaturationFit/"
    

        
      DecapoleMagnet : multipoles
        
          
    
        
        
        DecapoleMagnet --> "0..1" Multipoles : multipoles
        click Multipoles href "../Multipoles/"
    

        
      DecapoleMagnet : order
        
      DecapoleMagnet : plane
        
          
    
        
        
        DecapoleMagnet --> "0..1" BendingPlaneEnum : plane
        click BendingPlaneEnum href "../BendingPlaneEnum/"
    

        
      DecapoleMagnet : random_multipoles
        
          
    
        
        
        DecapoleMagnet --> "0..1" Multipoles : random_multipoles
        click Multipoles href "../Multipoles/"
    

        
      DecapoleMagnet : settle_time
        
      DecapoleMagnet : skew
        
      DecapoleMagnet : systematic_multipoles
        
          
    
        
        
        DecapoleMagnet --> "0..1" Multipoles : systematic_multipoles
        click Multipoles href "../Multipoles/"
...
| ---  | --- | --- | --- |
| [Decapole](Decapole.md) | [magnetic](magnetic.md) | range | [DecapoleMagnet](DecapoleMagnet.md) |
...
| ---  | ---  |
| self | laura:DecapoleMagnet |
| native | laura:DecapoleMagnet |
...
<details>
```yaml
name: Decapole_Magnet
description: Decapole magnet field, principal multipole order 4.
