...
_Pixel-to-mm scale factor in y._
...
URI: [laura:y_pixels_to_mm](https://w3id.org/laura/y_pixels_to_mm)
...
| ---  | ---  |
| self | laura:y_pixels_to_mm |
| native | laura:y_pixels_to_mm |
