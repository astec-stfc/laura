...
_Generic power-supply unit providing control/setpoint-driven outputs (for example current/voltage) to other accelerator components._
...
URI: [laura:PowerSupply](https://w3id.org/laura/PowerSupply)
...
```mermaid
 classDiagram
    ...
    click PowerSupply href "../PowerSupply/"
      ...
      PowerSupply : controls
        
          
    
        
        
        PowerSupply --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      PowerSupply : downstream
        
          
    
        
        
        PowerSupply --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      PowerSupply : electrical
        
          
    
        
        
        PowerSupply --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      PowerSupply : hardware_class
        
          
    
        
        
        PowerSupply --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      PowerSupply : hardware_model
        
      PowerSupply : hardware_type
        
      PowerSupply : inherits_from
      ...
      PowerSupply : inputs
        ...
        PowerSupply --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      PowerSupply : machine_area
      ...
      PowerSupply : manufacturer
        ...
        PowerSupply --> "0..1" ManufacturerElement : manufacturer
      ...
      PowerSupply : outputs
        ...
        PowerSupply --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
      ...
      PowerSupply : reference
        ...
        PowerSupply --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      PowerSupply : simulation
        
          
    
        
        
        PowerSupply --> "0..1" SimulationElement : simulation
        click SimulationElement href "../SimulationElement/"
    

        
      PowerSupply : subelement
        
      PowerSupply : upstream
        
          
    
        
        
        PowerSupply --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      PowerSupply : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:PowerSupply](https://w3id.org/laura/PowerSupply) |
...
| ---  | ---  |
| self | laura:PowerSupply |
| native | laura:PowerSupply |
...
```yaml
name: PowerSupply
description: Generic power-supply unit providing control/setpoint-driven outputs (for
  example current/voltage) to other accelerator components.
