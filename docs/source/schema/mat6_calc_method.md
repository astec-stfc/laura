# Slot: mat6_calc_method 


_Method used to calculate the element's 6x6 transfer matrix._
...
URI: [laura:mat6_calc_method](https://w3id.org/laura/mat6_calc_method)
...
| ---  | ---  |
| self | laura:mat6_calc_method |
| native | laura:mat6_calc_method |
