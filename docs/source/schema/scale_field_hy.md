...
_y-component of the horizontal direction vector._
...
URI: [laura:scale_field_hy](https://w3id.org/laura/scale_field_hy)
...
| ---  | ---  |
| self | laura:scale_field_hy |
| native | laura:scale_field_hy |
