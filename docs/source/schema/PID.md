...
_Proportional-integral-derivative (PID) feedback controller._
...
URI: [laura:PID](https://w3id.org/laura/PID)
 ...
 classDiagram
    ...
    click PID href "../PID/"
      ...
      PID : controls
        ...
        PID --> "0..1" ControlsInformation : controls
      ...
      PID : downstream
        ...
        PID --> "*" AcceleratorElement : downstream
      ...
      PID : electrical
        ...
        PID --> "0..1" ElectricalElement : electrical
      ...
      PID : hardware_class
        ...
        PID --> "1" HardwareClassEnum : hardware_class
      ...
      PID : manufacturer
        ...
        PID --> "0..1" ManufacturerElement : manufacturer
      ...
      PID : reference
        ...
        PID --> "0..1" ReferenceElement : reference
      ...
      PID : simulation
        ...
        PID --> "0..1" SimulationElement : simulation
      ...
      PID : upstream
        ...
        PID --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
...
| Property | Value |
| --- | --- |
| Class URI | [laura:PID](https://w3id.org/laura/PID) |
...
| ---  | --- | --- | --- |
| [pid](pid.md) | 0..1 <br/> [PIDElement](PIDElement.md) | PID gain parameters | direct |
