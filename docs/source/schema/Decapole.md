...
URI: [laura:Decapole](https://w3id.org/laura/Decapole)
 ...
 classDiagram
    ...
    click Decapole href "../Decapole/"
      ...
      Decapole : aperture
        ...
        Decapole --> "0..1" ApertureElement : aperture
      ...
      Decapole : controls
        ...
        Decapole --> "0..1" ControlsInformation : controls
      ...
      Decapole : degauss
        ...
        Decapole --> "0..1" DegaussableElement : degauss
      ...
      Decapole : downstream
        ...
        Decapole --> "*" AcceleratorElement : downstream
      ...
      Decapole : electrical
        ...
        Decapole --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      Decapole : hardware_class
        
          
    
        
        
        Decapole --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      Decapole : hardware_model
        
      Decapole : hardware_type
      ...
      Decapole : inputs
        ...
        Decapole --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      Decapole : machine_area
      ...
      Decapole : magnetic
        ...
        Decapole --> "0..1" DecapoleMagnet : magnetic
        click DecapoleMagnet href "../DecapoleMagnet/"
    

        
      Decapole : manufacturer
        
          
    
        
        
        Decapole --> "0..1" ManufacturerElement : manufacturer
      ...
      Decapole : physical
        ...
        Decapole --> "0..1" PhysicalElement : physical
      ...
      Decapole : reference
        ...
        Decapole --> "0..1" ReferenceElement : reference
      ...
      Decapole : simulation
        ...
        Decapole --> "0..1" MagnetSimulationElement : simulation
      ...
      Decapole : upstream
        ...
        Decapole --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      Decapole : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:Decapole](https://w3id.org/laura/Decapole) |
...
| ---  | --- | --- | --- |
| [magnetic](magnetic.md) | 0..1 <br/> [DecapoleMagnet](DecapoleMagnet.md) | Magnetic field parameters | [Magnet](Magnet.md) |
...
```yaml
name: Decapole
description: Decapole magnet.
from_schema: https://w3id.org/laura/schema
is_a: Magnet
slot_usage:
  magnetic:
    name: magnetic
    range: Decapole_Magnet
  hardware_type:
    name: hardware_type
    ifabsent: Decapole
    equals_string: Decapole
class_uri: laura:Decapole
