...
URI: [laura:beampipe_size](https://w3id.org/laura/beampipe_size)
...
| Domain Of | [SectionLattice](SectionLattice.md), [MachineModel](MachineModel.md) |
...
| ---  | ---  |
| self | laura:beampipe_size |
| native | laura:beampipe_size |
