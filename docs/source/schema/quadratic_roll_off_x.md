# Slot: quadratic_roll_off_x 


_Quadratic field roll-off in x [1/m^2]._
...
URI: [laura:quadratic_roll_off_x](https://w3id.org/laura/quadratic_roll_off_x)
...
| ---  | ---  |
| self | laura:quadratic_roll_off_x |
| native | laura:quadratic_roll_off_x |
