...
_Alternative internal name used by the control system when the physical name is inaccessible._
...
URI: [laura:virtual_name](https://w3id.org/laura/virtual_name)
...
| ---  | ---  |
| self | laura:virtual_name |
| native | laura:virtual_name |
