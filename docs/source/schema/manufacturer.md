...
URI: [laura:manufacturer](https://w3id.org/laura/manufacturer)
...
| Domain Of | [ManufacturerElement](ManufacturerElement.md), [StandardElement](StandardElement.md) |
...
| ---  | ---  |
| self | laura:manufacturer |
| native | laura:manufacturer |
