...
_Beam or laser shutter with interlock logic._
...
URI: [laura:Shutter](https://w3id.org/laura/Shutter)
 ...
 classDiagram
    ...
    click Shutter href "../Shutter/"
      ...
      Shutter : aperture
        ...
        Shutter --> "0..1" ApertureElement : aperture
      ...
      Shutter : downstream
        ...
        Shutter --> "*" AcceleratorElement : downstream
      ...
      Shutter : electrical
        ...
        Shutter --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      Shutter : hardware_class
        
          
    
        
        
        Shutter --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      Shutter : hardware_model
        
      Shutter : hardware_type
        
      Shutter : inherits_from
      ...
      Shutter : inputs
        ...
        Shutter --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      Shutter : machine_area
      ...
      Shutter : manufacturer
        ...
        Shutter --> "0..1" ManufacturerElement : manufacturer
      ...
      Shutter : physical
        ...
        Shutter --> "0..1" PhysicalElement : physical
      ...
      Shutter : reference
        ...
        Shutter --> "0..1" ReferenceElement : reference
      ...
      Shutter : shutter
        ...
        Shutter --> "0..1" ShutterElement : shutter
      ...
      Shutter : simulation
        ...
        Shutter --> "0..1" SimulationElement : simulation
      ...
      Shutter : upstream
        ...
        Shutter --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      Shutter : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:Shutter](https://w3id.org/laura/Shutter) |
...
| ---  | --- | --- | --- |
| [shutter](shutter.md) | 0..1 <br/> [ShutterElement](ShutterElement.md) | Shutter interlock configuration | direct |
