...
_Weak-strong beam-beam interaction element._
...
URI: [laura:BeamBeam](https://w3id.org/laura/BeamBeam)
 ...
 classDiagram
    ...
    click BeamBeam href "../BeamBeam/"
      ...
      BeamBeam : aperture
        ...
        BeamBeam --> "0..1" ApertureElement : aperture
      ...
      BeamBeam : controls
        ...
        BeamBeam --> "0..1" ControlsInformation : controls
      ...
      BeamBeam : downstream
        ...
        BeamBeam --> "*" AcceleratorElement : downstream
      ...
      BeamBeam : electrical
        ...
        BeamBeam --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      BeamBeam : hardware_class
        
          
    
        
        
        BeamBeam --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      BeamBeam : hardware_model
        
      BeamBeam : hardware_type
        
      BeamBeam : inherits_from
      ...
      BeamBeam : inputs
        ...
        BeamBeam --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      BeamBeam : machine_area
        
      BeamBeam : manufacturer
        
          
    
        
        
        BeamBeam --> "0..1" ManufacturerElement : manufacturer
      ...
      BeamBeam : physical
        ...
        BeamBeam --> "0..1" PhysicalElement : physical
      ...
      BeamBeam : reference
        ...
        BeamBeam --> "0..1" ReferenceElement : reference
      ...
      BeamBeam : simulation
        ...
        BeamBeam --> "0..1" BeamBeamSimulationElement : simulation
      ...
      BeamBeam : upstream
        ...
        BeamBeam --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      BeamBeam : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:BeamBeam](https://w3id.org/laura/BeamBeam) |
...
| [simulation](simulation.md) | 0..1 <br/> [BeamBeamSimulationElement](BeamBeamSimulationElement.md) | Simulation / tracking attributes | [StandardElement](StandardElement.md) |
