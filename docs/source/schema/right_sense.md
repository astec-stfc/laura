...
_Sign relating a rightward move to the actuator's direction._
...
URI: [laura:right_sense](https://w3id.org/laura/right_sense)
...
| ---  | ---  |
| self | laura:right_sense |
| native | laura:right_sense |
