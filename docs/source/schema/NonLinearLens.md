...
_Non-linear integrable-optics lens._
...
URI: [laura:NonLinearLens](https://w3id.org/laura/NonLinearLens)
...
```mermaid
 classDiagram
    ...
    click NonLinearLens href "../NonLinearLens/"
      ...
      NonLinearLens : aperture
        
          
    
        
        
        NonLinearLens --> "0..1" ApertureElement : aperture
        click ApertureElement href "../ApertureElement/"
    

        
      NonLinearLens : controls
        
          
    
        
        
        NonLinearLens --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      NonLinearLens : degauss
        
          
    
        
        
        NonLinearLens --> "0..1" DegaussableElement : degauss
        click DegaussableElement href "../DegaussableElement/"
    

        
      NonLinearLens : downstream
        
          
    
        
        
        NonLinearLens --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      NonLinearLens : electrical
        
          
    
        
        
        NonLinearLens --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      NonLinearLens : hardware_class
        
          
    
        
        
        NonLinearLens --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      NonLinearLens : hardware_model
        
      NonLinearLens : hardware_type
        
      NonLinearLens : inherits_from
        
      NonLinearLens : inputs
        
          
    
        
        
        NonLinearLens --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      NonLinearLens : machine_area
        
      NonLinearLens : magnetic
        
          
    
        
        
        NonLinearLens --> "0..1" NonLinearLensMagnet : magnetic
        click NonLinearLensMagnet href "../NonLinearLensMagnet/"
    

        
      NonLinearLens : manufacturer
        
          
    
        
        
        NonLinearLens --> "0..1" ManufacturerElement : manufacturer
      ...
      NonLinearLens : outputs
        
          
    
        
        
        NonLinearLens --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      NonLinearLens : physical
        
          
    
        
        
        NonLinearLens --> "0..1" PhysicalElement : physical
        click PhysicalElement href "../PhysicalElement/"
    

        
      NonLinearLens : reference
        
          
    
        
        
        NonLinearLens --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      NonLinearLens : simulation
        
          
    
        
        
        NonLinearLens --> "0..1" MagnetSimulationElement : simulation
        click MagnetSimulationElement href "../MagnetSimulationElement/"
    

        
      NonLinearLens : subelement
        
      NonLinearLens : upstream
        
          
    
        
        
        NonLinearLens --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      NonLinearLens : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:NonLinearLens](https://w3id.org/laura/NonLinearLens) |
...
| ---  | --- | --- | --- |
| [magnetic](magnetic.md) | 0..1 <br/> [NonLinearLensMagnet](NonLinearLensMagnet.md) | Magnetic field parameters | [Magnet](Magnet.md) |
...
| ---  | ---  |
| self | laura:NonLinearLens |
| native | laura:NonLinearLens |
...
```yaml
name: NonLinearLens
description: Non-linear integrable-optics lens.
