...
_Non-linear focusing lens (IOTA-style)._
 ...
 classDiagram
    ...
    click NonLinearLens href "../NonLinearLens/"
      ...
      NonLinearLens : hardware_class
        ...
        NonLinearLens --> "0..1" HardwareClassEnum : hardware_class
      ...
      NonLinearLens : magnetic
        ...
        NonLinearLens --> "0..1" MagneticElement : magnetic
