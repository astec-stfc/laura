# Class: CombinedSolenoidQuadrupole 


_Magnet combining coaxial solenoid and quadrupole fields._
...
URI: [laura:CombinedSolenoidQuadrupole](https://w3id.org/laura/CombinedSolenoidQuadrupole)
...
```mermaid
 classDiagram
    ...
    click CombinedSolenoidQuadrupole href "../CombinedSolenoidQuadrupole/"
      ...
      CombinedSolenoidQuadrupole : alias
        
      CombinedSolenoidQuadrupole : aperture
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "0..1" ApertureElement : aperture
        click ApertureElement href "../ApertureElement/"
    

        
      CombinedSolenoidQuadrupole : controls
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      CombinedSolenoidQuadrupole : degauss
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "0..1" DegaussableElement : degauss
        click DegaussableElement href "../DegaussableElement/"
    

        
      CombinedSolenoidQuadrupole : downstream
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      CombinedSolenoidQuadrupole : electrical
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      CombinedSolenoidQuadrupole : hardware_class
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      CombinedSolenoidQuadrupole : hardware_model
        
      CombinedSolenoidQuadrupole : hardware_type
        
      CombinedSolenoidQuadrupole : inherits_from
        
      CombinedSolenoidQuadrupole : inputs
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      CombinedSolenoidQuadrupole : machine_area
        
      CombinedSolenoidQuadrupole : magnetic
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "0..1" CombinedSolenoidQuadrupoleMagnet : magnetic
        click CombinedSolenoidQuadrupoleMagnet href "../CombinedSolenoidQuadrupoleMagnet/"
    

        
      CombinedSolenoidQuadrupole : manufacturer
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "0..1" ManufacturerElement : manufacturer
        click ManufacturerElement href "../ManufacturerElement/"
    

        
      CombinedSolenoidQuadrupole : name
        
      CombinedSolenoidQuadrupole : outputs
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      CombinedSolenoidQuadrupole : physical
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "0..1" PhysicalElement : physical
        click PhysicalElement href "../PhysicalElement/"
    

        
      CombinedSolenoidQuadrupole : reference
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      CombinedSolenoidQuadrupole : simulation
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "0..1" MagnetSimulationElement : simulation
        click MagnetSimulationElement href "../MagnetSimulationElement/"
    

        
      CombinedSolenoidQuadrupole : subelement
        
      CombinedSolenoidQuadrupole : upstream
        
          
    
        
        
        CombinedSolenoidQuadrupole --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      CombinedSolenoidQuadrupole : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:CombinedSolenoidQuadrupole](https://w3id.org/laura/CombinedSolenoidQuadrupole) |
...
| ---  | --- | --- | --- |
| [magnetic](magnetic.md) | 0..1 <br/> [CombinedSolenoidQuadrupoleMagnet](CombinedSolenoidQuadrupoleMagnet.md) | Magnetic field parameters | [Magnet](Magnet.md) |
...
| ---  | ---  |
| self | laura:CombinedSolenoidQuadrupole |
| native | laura:CombinedSolenoidQuadrupole |
...
<details>
```yaml
name: CombinedSolenoidQuadrupole
description: Magnet combining coaxial solenoid and quadrupole fields.
...
class_uri: laura:CombinedSolenoidQuadrupole
...
attributes:
  magnetic:
    ...
    rank: 1000
    owner: CombinedSolenoidQuadrupole
    domain_of:
    - Magnet
    range: CombinedSolenoidQuadrupoleMagnet
  degauss:
