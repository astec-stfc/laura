# Class: WallCurrentMonitor 


_Wall-current monitor (WCM) for non-destructive charge measurement._
...
URI: [laura:WallCurrentMonitor](https://w3id.org/laura/WallCurrentMonitor)
...
```mermaid
 classDiagram
    ...
    click WallCurrentMonitor href "../WallCurrentMonitor/"
      ...
      WallCurrentMonitor : alias
        
      WallCurrentMonitor : aperture
        
          
    
        
        
        WallCurrentMonitor --> "0..1" ApertureElement : aperture
        click ApertureElement href "../ApertureElement/"
    

        
      WallCurrentMonitor : controls
        
          
    
        
        
        WallCurrentMonitor --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      WallCurrentMonitor : diagnostic
        
          
    
        
        
        WallCurrentMonitor --> "0..1" ChargeDiagnosticElement : diagnostic
        click ChargeDiagnosticElement href "../ChargeDiagnosticElement/"
    

        
      WallCurrentMonitor : downstream
        
          
    
        
        
        WallCurrentMonitor --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      WallCurrentMonitor : electrical
        
          
    
        
        
        WallCurrentMonitor --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      WallCurrentMonitor : hardware_class
        
          
    
        
        
        WallCurrentMonitor --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      WallCurrentMonitor : hardware_model
        
      WallCurrentMonitor : hardware_type
        
      WallCurrentMonitor : inherits_from
        
      WallCurrentMonitor : inputs
        
          
    
        
        
        WallCurrentMonitor --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      WallCurrentMonitor : machine_area
        
      WallCurrentMonitor : manufacturer
        
          
    
        
        
        WallCurrentMonitor --> "0..1" ManufacturerElement : manufacturer
        click ManufacturerElement href "../ManufacturerElement/"
    

        
      WallCurrentMonitor : name
        
      WallCurrentMonitor : outputs
        
          
    
        
        
        WallCurrentMonitor --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      WallCurrentMonitor : physical
        
          
    
        
        
        WallCurrentMonitor --> "0..1" PhysicalElement : physical
        click PhysicalElement href "../PhysicalElement/"
    

        
      WallCurrentMonitor : reference
        
          
    
        
        
        WallCurrentMonitor --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      WallCurrentMonitor : simulation
        
          
    
        
        
        WallCurrentMonitor --> "0..1" DiagnosticSimulationElement : simulation
        click DiagnosticSimulationElement href "../DiagnosticSimulationElement/"
    

        
      WallCurrentMonitor : subelement
        
      WallCurrentMonitor : upstream
        
          
    
        
        
        WallCurrentMonitor --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      WallCurrentMonitor : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:WallCurrentMonitor](https://w3id.org/laura/WallCurrentMonitor) |
...
| ---  | ---  |
| self | laura:WallCurrentMonitor |
| native | laura:WallCurrentMonitor |
