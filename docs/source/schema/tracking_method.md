# Slot: tracking_method 


_Phase-space tracking algorithm requested from the target code._
...
URI: [laura:tracking_method](https://w3id.org/laura/tracking_method)
...
| ---  | ---  |
| self | laura:tracking_method |
| native | laura:tracking_method |
