...
_Virtual survey marker -- a zero-length reference point used for alignment._
...
URI: [laura:Marker](https://w3id.org/laura/Marker)
 ...
 classDiagram
    ...
    click Marker href "../Marker/"
      ...
      Marker : controls
        ...
        Marker --> "0..1" ControlsInformation : controls
      ...
      Marker : downstream
        ...
        Marker --> "*" AcceleratorElement : downstream
      ...
      Marker : electrical
        ...
        Marker --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      Marker : hardware_class
        
          
    
        
        
        Marker --> "1" HardwareClassEnum : hardware_class
      ...
      Marker : manufacturer
        ...
        Marker --> "0..1" ManufacturerElement : manufacturer
      ...
      Marker : physical
        ...
        Marker --> "0..1" PhysicalElement : physical
      ...
      Marker : reference
        ...
        Marker --> "0..1" ReferenceElement : reference
      ...
      Marker : simulation
        ...
        Marker --> "0..1" SimulationElement : simulation
      ...
      Marker : upstream
        ...
        Marker --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
...
| Property | Value |
| --- | --- |
| Class URI | [laura:Marker](https://w3id.org/laura/Marker) |
...
```yaml
name: Marker
description: Virtual survey marker -- a zero-length reference point used for alignment.
