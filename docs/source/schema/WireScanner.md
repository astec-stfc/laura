...
_Intercepting wire scanner for transverse profile measurement._
 ...
 classDiagram
    ...
    click WireScanner href "../WireScanner/"
      ...
      WireScanner : diagnostic
        ...
        WireScanner --> "0..1" WireScannerDiagnosticElement : diagnostic
...
| ---  | --- | --- | --- |
| [diagnostic](diagnostic.md) | 0..1 <br/> [WireScannerDiagnosticElement](WireScannerDiagnosticElement.md) | Instrument-specific diagnostic parameters | direct |
...
```yaml
name: WireScanner
description: Intercepting wire scanner for transverse profile measurement.
...
attributes:
  diagnostic:
    ...
    - ChargeDiagnostic
    - PhotonMonitor
    range: WireScannerDiagnosticElement
