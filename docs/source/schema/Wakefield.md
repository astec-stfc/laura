...
_Passive wakefield structure (dielectric, corrugated, etc.)._
...
URI: [laura:Wakefield](https://w3id.org/laura/Wakefield)
 ...
 classDiagram
    ...
    click Wakefield href "../Wakefield/"
      ...
      Wakefield : aperture
        ...
        Wakefield --> "0..1" ApertureElement : aperture
      ...
      Wakefield : cavity
        ...
        Wakefield --> "0..1" WakefieldElement : cavity
      ...
      Wakefield : controls
        ...
        Wakefield --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      Wakefield : downstream
        
          
    
        
        
        Wakefield --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      Wakefield : electrical
        
          
    
        
        
        Wakefield --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      Wakefield : hardware_class
        
          
    
        
        
        Wakefield --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      Wakefield : hardware_model
        
      Wakefield : hardware_type
        
      Wakefield : inherits_from
      ...
      Wakefield : inputs
        ...
        Wakefield --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      Wakefield : machine_area
        
      Wakefield : manufacturer
        
          
    
        
        
        Wakefield --> "0..1" ManufacturerElement : manufacturer
      ...
      Wakefield : physical
        ...
        Wakefield --> "0..1" PhysicalElement : physical
      ...
      Wakefield : reference
        ...
        Wakefield --> "0..1" ReferenceElement : reference
      ...
      Wakefield : simulation
        ...
        Wakefield --> "0..1" WakefieldSimulationElement : simulation
        click WakefieldSimulationElement href "../WakefieldSimulationElement/"
    

        
      Wakefield : subelement
      ...
      Wakefield : upstream
        ...
        Wakefield --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      Wakefield : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:Wakefield](https://w3id.org/laura/Wakefield) |
...
| ---  | --- | --- | --- |
| [cavity](cavity.md) | 0..1 <br/> [WakefieldElement](WakefieldElement.md) | Wakefield structure parameters | direct |
...
| [simulation](simulation.md) | 0..1 <br/> [WakefieldSimulationElement](WakefieldSimulationElement.md) | Simulation / tracking attributes | [StandardElement](StandardElement.md) |
...
| ---  | ---  |
| self | laura:Wakefield |
| native | laura:Wakefield |
