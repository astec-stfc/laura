# Slot: horizontal_offset 


_Horizontal simulation offset from the reference orbit [m]._
...
URI: [laura:horizontal_offset](https://w3id.org/laura/horizontal_offset)
...
| ---  | ---  |
| self | laura:horizontal_offset |
| native | laura:horizontal_offset |
