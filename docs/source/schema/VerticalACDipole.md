# Class: VerticalACDipole 


_Vertically deflecting AC-dipole tune exciter._
...
URI: [laura:Vertical_AC_Dipole](https://w3id.org/laura/Vertical_AC_Dipole)
...
```mermaid
 classDiagram
    class VerticalACDipole
    click VerticalACDipole href "../VerticalACDipole/"
      ACDipole <|-- VerticalACDipole
        click ACDipole href "../ACDipole/"
      
      VerticalACDipole : alias
        
      VerticalACDipole : aperture
        
          
    
        
        
        VerticalACDipole --> "0..1" ApertureElement : aperture
        click ApertureElement href "../ApertureElement/"
    

        
      VerticalACDipole : controls
        
          
    
        
        
        VerticalACDipole --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      VerticalACDipole : downstream
        
          
    
        
        
        VerticalACDipole --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      VerticalACDipole : electrical
        
          
    
        
        
        VerticalACDipole --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      VerticalACDipole : hardware_class
        
          
    
        
        
        VerticalACDipole --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      VerticalACDipole : hardware_model
        
      VerticalACDipole : hardware_type
        
      VerticalACDipole : inherits_from
        
      VerticalACDipole : inputs
        
          
    
        
        
        VerticalACDipole --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      VerticalACDipole : machine_area
        
      VerticalACDipole : manufacturer
        
          
    
        
        
        VerticalACDipole --> "0..1" ManufacturerElement : manufacturer
        click ManufacturerElement href "../ManufacturerElement/"
    

        
      VerticalACDipole : name
        
      VerticalACDipole : outputs
        
          
    
        
        
        VerticalACDipole --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      VerticalACDipole : physical
        
          
    
        
        
        VerticalACDipole --> "0..1" PhysicalElement : physical
        click PhysicalElement href "../PhysicalElement/"
    

        
      VerticalACDipole : reference
        
          
    
        
        
        VerticalACDipole --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      VerticalACDipole : simulation
        
          
    
        
        
        VerticalACDipole --> "0..1" ACDipoleSimulationElement : simulation
        click ACDipoleSimulationElement href "../ACDipoleSimulationElement/"
    

        
      VerticalACDipole : subelement
        
      VerticalACDipole : upstream
        
          
    
        
        
        VerticalACDipole --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      VerticalACDipole : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:Vertical_AC_Dipole](https://w3id.org/laura/Vertical_AC_Dipole) |
...
| ---  | ---  |
| self | laura:Vertical_AC_Dipole |
| native | laura:VerticalACDipole |
