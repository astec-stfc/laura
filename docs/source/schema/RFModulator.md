...
_RF modulator (klystron driver) element._
...
URI: [laura:RFModulator](https://w3id.org/laura/RFModulator)
...
```mermaid
 classDiagram
    ...
    click RFModulator href "../RFModulator/"
      ...
      RFModulator : controls
        
          
    
        
        
        RFModulator --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      RFModulator : downstream
        
          
    
        
        
        RFModulator --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      RFModulator : electrical
        
          
    
        
        
        RFModulator --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      RFModulator : hardware_class
        
          
    
        
        
        RFModulator --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      RFModulator : hardware_model
        
      RFModulator : hardware_type
        
      RFModulator : inherits_from
      ...
      RFModulator : inputs
        ...
        RFModulator --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      RFModulator : machine_area
        
      RFModulator : manufacturer
        
          
    
        
        
        RFModulator --> "0..1" ManufacturerElement : manufacturer
      ...
      RFModulator : modulator
        ...
        RFModulator --> "0..1" RFModulatorElement : modulator
        click RFModulatorElement href "../RFModulatorElement/"
      ...
      RFModulator : outputs
        ...
        RFModulator --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      RFModulator : reference
        
          
    
        
        
        RFModulator --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      RFModulator : simulation
        
          
    
        
        
        RFModulator --> "0..1" SimulationElement : simulation
        click SimulationElement href "../SimulationElement/"
    

        
      RFModulator : subelement
        
      RFModulator : upstream
        
          
    
        
        
        RFModulator --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      RFModulator : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:RFModulator](https://w3id.org/laura/RFModulator) |
...
| ---  | --- | --- | --- |
| [modulator](modulator.md) | 0..1 <br/> [RFModulatorElement](RFModulatorElement.md) | Modulator parameters | direct |
...
| ---  | ---  |
| self | laura:RFModulator |
| native | laura:RFModulator |
