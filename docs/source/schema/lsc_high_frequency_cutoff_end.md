# Slot: lsc_high_frequency_cutoff_end 


_High-frequency cutoff end for LSC._
...
URI: [laura:lsc_high_frequency_cutoff_end](https://w3id.org/laura/lsc_high_frequency_cutoff_end)
...
| ---  | ---  |
| self | laura:lsc_high_frequency_cutoff_end |
| native | laura:lsc_high_frequency_cutoff_end |
