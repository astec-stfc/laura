...
_Transverse-deflecting crab cavity for crossing-angle compensation._
...
URI: [laura:CrabCavity](https://w3id.org/laura/CrabCavity)
 ...
 classDiagram
    ...
    click CrabCavity href "../CrabCavity/"
      ...
      CrabCavity : aperture
        ...
        CrabCavity --> "0..1" ApertureElement : aperture
      ...
      CrabCavity : cavity
        ...
        CrabCavity --> "0..1" RFDeflectingCavityElement : cavity
      ...
      CrabCavity : controls
        ...
        CrabCavity --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      CrabCavity : downstream
        
          
    
        
        
        CrabCavity --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      CrabCavity : electrical
        
          
    
        
        
        CrabCavity --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      CrabCavity : hardware_class
        
          
    
        
        
        CrabCavity --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      CrabCavity : hardware_model
        
      CrabCavity : hardware_type
        
      CrabCavity : inherits_from
      ...
      CrabCavity : inputs
        ...
        CrabCavity --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      CrabCavity : machine_area
        
      CrabCavity : manufacturer
        
          
    
        
        
        CrabCavity --> "0..1" ManufacturerElement : manufacturer
      ...
      CrabCavity : physical
        ...
        CrabCavity --> "0..1" PhysicalElement : physical
        click PhysicalElement href "../PhysicalElement/"
    

        
      CrabCavity : reference
        
          
    
        
        
        CrabCavity --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      CrabCavity : simulation
        
          
    
        
        
        CrabCavity --> "0..1" RFCavitySimulationElement : simulation
        click RFCavitySimulationElement href "../RFCavitySimulationElement/"
    

        
      CrabCavity : subelement
      ...
      CrabCavity : upstream
        ...
        CrabCavity --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      CrabCavity : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:CrabCavity](https://w3id.org/laura/CrabCavity) |
...
| ---  | --- | --- | --- |
| [cavity](cavity.md) | 0..1 <br/> [RFDeflectingCavityElement](RFDeflectingCavityElement.md) | Crab-cavity RF structure parameters | direct |
...
| ---  | ---  |
| self | laura:CrabCavity |
| native | laura:CrabCavity |
