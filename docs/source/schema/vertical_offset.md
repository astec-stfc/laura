...
_Vertical simulation offset from the reference orbit [m]._
...
URI: [laura:vertical_offset](https://w3id.org/laura/vertical_offset)
...
| ---  | ---  |
| self | laura:vertical_offset |
| native | laura:vertical_offset |
