# Slot: particles_per_longitudinal_cell 


_Number of plasma particles per longitudinal cell._
...
URI: [laura:particles_per_longitudinal_cell](https://w3id.org/laura/particles_per_longitudinal_cell)
...
| ---  | ---  |
| self | laura:particles_per_longitudinal_cell |
| native | laura:particles_per_longitudinal_cell |
