# Slot: wakefield_model 


_Wakefield model identifier._
...
URI: [laura:wakefield_model](https://w3id.org/laura/wakefield_model)
...
| ---  | ---  |
| self | laura:wakefield_model |
| native | laura:wakefield_model |
