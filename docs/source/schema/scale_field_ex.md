...
_x-component of the longitudinal direction vector._
...
URI: [laura:scale_field_ex](https://w3id.org/laura/scale_field_ex)
...
| ---  | ---  |
| self | laura:scale_field_ex |
| native | laura:scale_field_ex |
