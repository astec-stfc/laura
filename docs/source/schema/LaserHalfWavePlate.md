...
_Half-wave plate for laser polarisation rotation._
...
URI: [laura:LaserHalfWavePlate](https://w3id.org/laura/LaserHalfWavePlate)
...
```mermaid
 classDiagram
    ...
    click LaserHalfWavePlate href "../LaserHalfWavePlate/"
      ...
      LaserHalfWavePlate : alias
        
      LaserHalfWavePlate : controls
        
          
    
        
        
        LaserHalfWavePlate --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      LaserHalfWavePlate : downstream
        
          
    
        
        
        LaserHalfWavePlate --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      LaserHalfWavePlate : electrical
        
          
    
        
        
        LaserHalfWavePlate --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      LaserHalfWavePlate : hardware_class
        
          
    
        
        
        LaserHalfWavePlate --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      LaserHalfWavePlate : hardware_model
        
      LaserHalfWavePlate : hardware_type
        
      LaserHalfWavePlate : inherits_from
        
      LaserHalfWavePlate : inputs
        
          
    
        
        
        LaserHalfWavePlate --> "*" IOTypeEnum : inputs
      ...
      LaserHalfWavePlate : laser
        ...
        LaserHalfWavePlate --> "0..1" LaserHalfWavePlateElement : laser
        click LaserHalfWavePlateElement href "../LaserHalfWavePlateElement/"
    

        
      LaserHalfWavePlate : machine_area
        
      LaserHalfWavePlate : manufacturer
        
          
    
        
        
        LaserHalfWavePlate --> "0..1" ManufacturerElement : manufacturer
        click ManufacturerElement href "../ManufacturerElement/"
    

        
      LaserHalfWavePlate : name
        
      LaserHalfWavePlate : outputs
        
          
    
        
        
        LaserHalfWavePlate --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      LaserHalfWavePlate : reference
        
          
    
        
        
        LaserHalfWavePlate --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      LaserHalfWavePlate : simulation
        
          
    
        
        
        LaserHalfWavePlate --> "0..1" SimulationElement : simulation
        click SimulationElement href "../SimulationElement/"
    

        
      LaserHalfWavePlate : subelement
        
      LaserHalfWavePlate : upstream
        
          
    
        
        
        LaserHalfWavePlate --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      LaserHalfWavePlate : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:LaserHalfWavePlate](https://w3id.org/laura/LaserHalfWavePlate) |
...
| ---  | --- | --- | --- |
| [laser](laser.md) | 0..1 <br/> [LaserHalfWavePlateElement](LaserHalfWavePlateElement.md) | Half-wave plate parameters | direct |
...
| ---  | ---  |
| self | laura:LaserHalfWavePlate |
| native | laura:LaserHalfWavePlate |
