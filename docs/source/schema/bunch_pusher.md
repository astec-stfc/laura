...
_Pusher used to evolve bunch particles in time._
...
URI: [laura:bunch_pusher](https://w3id.org/laura/bunch_pusher)
...
| ---  | ---  |
| self | laura:bunch_pusher |
| native | laura:bunch_pusher |
