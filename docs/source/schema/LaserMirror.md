...
_Laser steering or focusing mirror._
...
URI: [laura:LaserMirror](https://w3id.org/laura/LaserMirror)
...
```mermaid
 classDiagram
    ...
    click LaserMirror href "../LaserMirror/"
      ...
      LaserMirror : downstream
        
          
    
        
        
        LaserMirror --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      LaserMirror : electrical
        
          
    
        
        
        LaserMirror --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      LaserMirror : hardware_class
        
          
    
        
        
        LaserMirror --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      LaserMirror : hardware_model
        
      LaserMirror : hardware_type
        
      LaserMirror : inherits_from
      ...
      LaserMirror : manufacturer
        ...
        LaserMirror --> "0..1" ManufacturerElement : manufacturer
      ...
      LaserMirror : outputs
        ...
        LaserMirror --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      LaserMirror : reference
        
          
    
        
        
        LaserMirror --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      LaserMirror : simulation
        
          
    
        
        
        LaserMirror --> "0..1" SimulationElement : simulation
        click SimulationElement href "../SimulationElement/"
    

        
      LaserMirror : subelement
        
      LaserMirror : upstream
        
          
    
        
        
        LaserMirror --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      LaserMirror : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:LaserMirror](https://w3id.org/laura/LaserMirror) |
...
| ---  | ---  |
| self | laura:LaserMirror |
| native | laura:LaserMirror |
