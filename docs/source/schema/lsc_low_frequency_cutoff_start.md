...
_Low-frequency cutoff start for LSC._
...
URI: [laura:lsc_low_frequency_cutoff_start](https://w3id.org/laura/lsc_low_frequency_cutoff_start)
...
| ---  | ---  |
| self | laura:lsc_low_frequency_cutoff_start |
| native | laura:lsc_low_frequency_cutoff_start |
