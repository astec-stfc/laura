...
_If set, this element is a logical sub-component of the named parent element._
...
URI: [laura:subelement](https://w3id.org/laura/subelement)
...
| ---  | ---  |
| self | laura:subelement |
| native | laura:subelement |
...
```yaml
name: subelement
description: If set, this element is a logical sub-component of the named parent element.
