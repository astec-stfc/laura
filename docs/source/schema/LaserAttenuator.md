...
_Laser power attenuator (waveplate + polariser combination)._
...
URI: [laura:LaserAttenuator](https://w3id.org/laura/LaserAttenuator)
...
```mermaid
 classDiagram
    ...
    click LaserAttenuator href "../LaserAttenuator/"
      ...
      LaserAttenuator : alias
        
      LaserAttenuator : controls
        
          
    
        
        
        LaserAttenuator --> "0..1" ControlsInformation : controls
      ...
      LaserAttenuator : electrical
        ...
        LaserAttenuator --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      LaserAttenuator : hardware_class
        
          
    
        
        
        LaserAttenuator --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      LaserAttenuator : hardware_model
        
      LaserAttenuator : hardware_type
        
      LaserAttenuator : inherits_from
      ...
      LaserAttenuator : manufacturer
        ...
        LaserAttenuator --> "0..1" ManufacturerElement : manufacturer
        click ManufacturerElement href "../ManufacturerElement/"
    

        
      LaserAttenuator : maximum
      ...
      LaserAttenuator : reference
        ...
        LaserAttenuator --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      LaserAttenuator : simulation
        
          
    
        
        
        LaserAttenuator --> "0..1" SimulationElement : simulation
...
| Property | Value |
| --- | --- |
| Class URI | [laura:LaserAttenuator](https://w3id.org/laura/LaserAttenuator) |
...
| ---  | ---  |
| self | laura:LaserAttenuator |
| native | laura:LaserAttenuator |
