...
_RF protection system element._
...
URI: [laura:RFProtection](https://w3id.org/laura/RFProtection)
...
```mermaid
 classDiagram
    ...
    click RFProtection href "../RFProtection/"
      ...
      RFProtection : controls
        
          
    
        
        
        RFProtection --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      RFProtection : downstream
        
          
    
        
        
        RFProtection --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      RFProtection : electrical
        
          
    
        
        
        RFProtection --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      RFProtection : hardware_class
        
          
    
        
        
        RFProtection --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      RFProtection : hardware_model
        
      RFProtection : hardware_type
        
      RFProtection : inherits_from
      ...
      RFProtection : inputs
        ...
        RFProtection --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      RFProtection : machine_area
        
      RFProtection : manufacturer
        
          
    
        
        
        RFProtection --> "0..1" ManufacturerElement : manufacturer
      ...
      RFProtection : outputs
        
          
    
        
        
        RFProtection --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      RFProtection : protection
        
          
    
        
        
        RFProtection --> "0..1" RFProtectionElement : protection
        click RFProtectionElement href "../RFProtectionElement/"
    

        
      RFProtection : reference
        
          
    
        
        
        RFProtection --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      RFProtection : simulation
        
          
    
        
        
        RFProtection --> "0..1" SimulationElement : simulation
        click SimulationElement href "../SimulationElement/"
    

        
      RFProtection : subelement
        
      RFProtection : upstream
        
          
    
        
        
        RFProtection --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      RFProtection : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:RFProtection](https://w3id.org/laura/RFProtection) |
...
| ---  | --- | --- | --- |
| [protection](protection.md) | 0..1 <br/> [RFProtectionElement](RFProtectionElement.md) | RF protection parameters | direct |
...
| ---  | ---  |
| self | laura:RFProtection |
| native | laura:RFProtection |
