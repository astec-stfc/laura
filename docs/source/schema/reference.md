...
_Links to design drawings and files._
...
URI: [laura:reference](https://w3id.org/laura/reference)
...
| Property | Value |
| --- | --- |
| Range | [ReferenceElement](ReferenceElement.md) |
...
| ---  | ---  |
| self | laura:reference |
| native | laura:reference |
