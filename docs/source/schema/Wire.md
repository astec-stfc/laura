...
_Current-carrying wire for long-range beam-beam compensation._
...
URI: [laura:Wire](https://w3id.org/laura/Wire)
 ...
 classDiagram
    ...
    click Wire href "../Wire/"
      ...
      Wire : aperture
        ...
        Wire --> "0..1" ApertureElement : aperture
      ...
      Wire : controls
        ...
        Wire --> "0..1" ControlsInformation : controls
      ...
      Wire : downstream
        ...
        Wire --> "*" AcceleratorElement : downstream
      ...
      Wire : electrical
        ...
        Wire --> "0..1" ElectricalElement : electrical
      ...
      Wire : hardware_class
        ...
        Wire --> "1" HardwareClassEnum : hardware_class
      ...
      Wire : manufacturer
        ...
        Wire --> "0..1" ManufacturerElement : manufacturer
      ...
      Wire : physical
        ...
        Wire --> "0..1" PhysicalElement : physical
      ...
      Wire : reference
        ...
        Wire --> "0..1" ReferenceElement : reference
      ...
      Wire : simulation
        ...
        Wire --> "0..1" WireSimulationElement : simulation
      ...
      Wire : upstream
        ...
        Wire --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
...
| Property | Value |
| --- | --- |
| Class URI | [laura:Wire](https://w3id.org/laura/Wire) |
...
| [simulation](simulation.md) | 0..1 <br/> [WireSimulationElement](WireSimulationElement.md) | Simulation / tracking attributes | [StandardElement](StandardElement.md) |
