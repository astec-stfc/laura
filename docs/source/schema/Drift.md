...
_Field-free drift space between elements._
...
URI: [laura:Drift](https://w3id.org/laura/Drift)
 ...
 classDiagram
    ...
    click Drift href "../Drift/"
      ...
      Drift : aperture
        ...
        Drift --> "0..1" ApertureElement : aperture
      ...
      Drift : controls
        ...
        Drift --> "0..1" ControlsInformation : controls
      ...
      Drift : downstream
        ...
        Drift --> "*" AcceleratorElement : downstream
      ...
      Drift : electrical
        ...
        Drift --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      Drift : hardware_class
        
          
    
        
        
        Drift --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      Drift : hardware_model
      ...
      Drift : manufacturer
        ...
        Drift --> "0..1" ManufacturerElement : manufacturer
      ...
      Drift : physical
        ...
        Drift --> "0..1" PhysicalElement : physical
      ...
      Drift : reference
        ...
        Drift --> "0..1" ReferenceElement : reference
      ...
      Drift : simulation
        ...
        Drift --> "0..1" DriftSimulationElement : simulation
      ...
      Drift : upstream
        ...
        Drift --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
...
| Property | Value |
| --- | --- |
| Class URI | [laura:Drift](https://w3id.org/laura/Drift) |
...
| [simulation](simulation.md) | 0..1 <br/> [DriftSimulationElement](DriftSimulationElement.md) | Simulation / tracking attributes | [StandardElement](StandardElement.md) |
