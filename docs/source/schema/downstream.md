...
_Names of elements this one feeds; the inverse of ``upstream``._
...
URI: [laura:downstream](https://w3id.org/laura/downstream)
...
| ---  | ---  |
| self | laura:downstream |
| native | laura:downstream |
