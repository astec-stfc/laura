...
_Functional category (e.g., ``Magnet``, ``Diagnostic``)._
...
URI: [laura:hardware_class](https://w3id.org/laura/hardware_class)
...
| Property | Value |
| --- | --- |
| Range | [HardwareClassEnum](HardwareClassEnum.md) |
...
| ---  | ---  |
| self | laura:hardware_class |
| native | laura:hardware_class |
