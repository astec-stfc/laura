...
_Horizontal steering corrector._
...
```mermaid
 classDiagram
    ...
    click HorizontalCorrector href "../HorizontalCorrector/"
      ...
      HorizontalCorrector : aperture
        
          
    
        
        
        HorizontalCorrector --> "0..1" ApertureElement : aperture
      ...
      HorizontalCorrector : downstream
        
          
    
        
        
        HorizontalCorrector --> "*" AcceleratorElement : downstream
      ...
      HorizontalCorrector : hardware_class
        ...
        HorizontalCorrector --> "1" HardwareClassEnum : hardware_class
      ...
      HorizontalCorrector : inherits_from
        
      HorizontalCorrector : inputs
        
          
    
        
        
        HorizontalCorrector --> "*" IOTypeEnum : inputs
      ...
      HorizontalCorrector : magnetic
        ...
        HorizontalCorrector --> "0..1" CorrectorMagnet : magnetic
      ...
      HorizontalCorrector : outputs
        
          
    
        
        
        HorizontalCorrector --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
      ...
      HorizontalCorrector : upstream
        
          
    
        
        
        HorizontalCorrector --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
...
description: Horizontal steering corrector.
