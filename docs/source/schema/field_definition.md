...
_Path to the 3-D field-map file._
...
URI: [laura:field_definition](https://w3id.org/laura/field_definition)
...
| ---  | ---  |
| self | laura:field_definition |
| native | laura:field_definition |
