# Slot: plasma_min_longitudinal_position 


_Longitudinal position at which the plasma column starts [m]._
...
URI: [laura:plasma_min_longitudinal_position](https://w3id.org/laura/plasma_min_longitudinal_position)
...
| ---  | ---  |
| self | laura:plasma_min_longitudinal_position |
| native | laura:plasma_min_longitudinal_position |
