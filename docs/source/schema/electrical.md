...
_Power-supply electrical limits._
...
URI: [laura:electrical](https://w3id.org/laura/electrical)
...
| Property | Value |
| --- | --- |
| Range | [ElectricalElement](ElectricalElement.md) |
...
| ---  | ---  |
| self | laura:electrical |
| native | laura:electrical |
