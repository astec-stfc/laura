# Slot: vertical_channel 


_Vertical control channel index._
...
URI: [laura:vertical_channel](https://w3id.org/laura/vertical_channel)
...
| ---  | ---  |
| self | laura:vertical_channel |
| native | laura:vertical_channel |
