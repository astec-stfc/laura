# Class: HorizontalACDipole 


_Horizontally deflecting AC-dipole tune exciter._
...
URI: [laura:Horizontal_AC_Dipole](https://w3id.org/laura/Horizontal_AC_Dipole)
...
```mermaid
 classDiagram
    class HorizontalACDipole
    click HorizontalACDipole href "../HorizontalACDipole/"
      ACDipole <|-- HorizontalACDipole
        click ACDipole href "../ACDipole/"
      
      HorizontalACDipole : alias
        
      HorizontalACDipole : aperture
        
          
    
        
        
        HorizontalACDipole --> "0..1" ApertureElement : aperture
        click ApertureElement href "../ApertureElement/"
    

        
      HorizontalACDipole : controls
        
          
    
        
        
        HorizontalACDipole --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      HorizontalACDipole : downstream
        
          
    
        
        
        HorizontalACDipole --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      HorizontalACDipole : electrical
        
          
    
        
        
        HorizontalACDipole --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      HorizontalACDipole : hardware_class
        
          
    
        
        
        HorizontalACDipole --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      HorizontalACDipole : hardware_model
        
      HorizontalACDipole : hardware_type
        
      HorizontalACDipole : inherits_from
        
      HorizontalACDipole : inputs
        
          
    
        
        
        HorizontalACDipole --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      HorizontalACDipole : machine_area
        
      HorizontalACDipole : manufacturer
        
          
    
        
        
        HorizontalACDipole --> "0..1" ManufacturerElement : manufacturer
        click ManufacturerElement href "../ManufacturerElement/"
    

        
      HorizontalACDipole : name
        
      HorizontalACDipole : outputs
        
          
    
        
        
        HorizontalACDipole --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      HorizontalACDipole : physical
        
          
    
        
        
        HorizontalACDipole --> "0..1" PhysicalElement : physical
        click PhysicalElement href "../PhysicalElement/"
    

        
      HorizontalACDipole : reference
        
          
    
        
        
        HorizontalACDipole --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      HorizontalACDipole : simulation
        
          
    
        
        
        HorizontalACDipole --> "0..1" ACDipoleSimulationElement : simulation
        click ACDipoleSimulationElement href "../ACDipoleSimulationElement/"
    

        
      HorizontalACDipole : subelement
        
      HorizontalACDipole : upstream
        
          
    
        
        
        HorizontalACDipole --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      HorizontalACDipole : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:Horizontal_AC_Dipole](https://w3id.org/laura/Horizontal_AC_Dipole) |
...
| ---  | ---  |
| self | laura:Horizontal_AC_Dipole |
| native | laura:HorizontalACDipole |
