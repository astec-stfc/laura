...
_Low-level RF (LLRF) controller._
...
URI: [laura:LowLevelRF](https://w3id.org/laura/LowLevelRF)
 ...
 classDiagram
    ...
    click LowLevelRF href "../LowLevelRF/"
      ...
      LowLevelRF : controls
        ...
        LowLevelRF --> "0..1" ControlsInformation : controls
      ...
      LowLevelRF : electrical
        ...
        LowLevelRF --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      LowLevelRF : hardware_class
        
          
    
        
        
        LowLevelRF --> "1" HardwareClassEnum : hardware_class
      ...
      LowLevelRF : llrf
        ...
        LowLevelRF --> "0..1" LowLevelRFElement : llrf
        click LowLevelRFElement href "../LowLevelRFElement/"
    

        
      LowLevelRF : machine_area
        
      LowLevelRF : manufacturer
        
          
    
        
        
        LowLevelRF --> "0..1" ManufacturerElement : manufacturer
      ...
      LowLevelRF : reference
        ...
        LowLevelRF --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      LowLevelRF : simulation
        
          
    
        
        
        LowLevelRF --> "0..1" SimulationElement : simulation
...
| Property | Value |
| --- | --- |
| Class URI | [laura:LowLevelRF](https://w3id.org/laura/LowLevelRF) |
...
| ---  | --- | --- | --- |
| [llrf](llrf.md) | 0..1 <br/> [LowLevelRFElement](LowLevelRFElement.md) | LLRF parameters | direct |
...
| ---  | ---  |
| self | laura:LowLevelRF |
| native | laura:LowLevelRF |
