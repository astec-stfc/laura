...
_Thin RF-driven multipole kick._
...
URI: [laura:RFMultipole](https://w3id.org/laura/RFMultipole)
...
```mermaid
 classDiagram
    ...
    click RFMultipole href "../RFMultipole/"
      ...
      RFMultipole : aperture
        
          
    
        
        
        RFMultipole --> "0..1" ApertureElement : aperture
        click ApertureElement href "../ApertureElement/"
    

        
      RFMultipole : controls
        
          
    
        
        
        RFMultipole --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      RFMultipole : downstream
        
          
    
        
        
        RFMultipole --> "*" AcceleratorElement : downstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      RFMultipole : electrical
        
          
    
        
        
        RFMultipole --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      RFMultipole : hardware_class
        
          
    
        
        
        RFMultipole --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      RFMultipole : hardware_model
        
      RFMultipole : hardware_type
        
      RFMultipole : inherits_from
      ...
      RFMultipole : inputs
        ...
        RFMultipole --> "*" IOTypeEnum : inputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      RFMultipole : machine_area
        
      RFMultipole : manufacturer
        
          
    
        
        
        RFMultipole --> "0..1" ManufacturerElement : manufacturer
      ...
      RFMultipole : outputs
        ...
        RFMultipole --> "*" IOTypeEnum : outputs
        click IOTypeEnum href "../IOTypeEnum/"
    

        
      RFMultipole : physical
        
          
    
        
        
        RFMultipole --> "0..1" PhysicalElement : physical
        click PhysicalElement href "../PhysicalElement/"
    

        
      RFMultipole : reference
        
          
    
        
        
        RFMultipole --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      RFMultipole : simulation
        
          
    
        
        
        RFMultipole --> "0..1" RFMultipoleSimulationElement : simulation
        click RFMultipoleSimulationElement href "../RFMultipoleSimulationElement/"
    

        
      RFMultipole : subelement
        
      RFMultipole : upstream
        
          
    
        
        
        RFMultipole --> "*" AcceleratorElement : upstream
        click AcceleratorElement href "../AcceleratorElement/"
    

        
      RFMultipole : virtual_name
...
| Property | Value |
| --- | --- |
| Class URI | [laura:RFMultipole](https://w3id.org/laura/RFMultipole) |
...
| [simulation](simulation.md) | 0..1 <br/> [RFMultipoleSimulationElement](RFMultipoleSimulationElement.md) | Simulation / tracking attributes | [StandardElement](StandardElement.md) |
...
| ---  | ---  |
| self | laura:RFMultipole |
| native | laura:RFMultipole |
