# Class: IntegratedCurrentTransformer 


_Integrated current transformer (ICT) for non-destructive single-shot charge measurement._
...
URI: [laura:IntegratedCurrentTransformer](https://w3id.org/laura/IntegratedCurrentTransformer)
...
```mermaid
 classDiagram
    ...
    click IntegratedCurrentTransformer href "../IntegratedCurrentTransformer/"
      ...
      IntegratedCurrentTransformer : alias
        
      IntegratedCurrentTransformer : aperture
        
          
    
        
        
        IntegratedCurrentTransformer --> "0..1" ApertureElement : aperture
        click ApertureElement href "../ApertureElement/"
    

        
      IntegratedCurrentTransformer : controls
        
          
    
        
        
        IntegratedCurrentTransformer --> "0..1" ControlsInformation : controls
        click ControlsInformation href "../ControlsInformation/"
    

        
      IntegratedCurrentTransformer : diagnostic
        
          
    
        
        
        IntegratedCurrentTransformer --> "0..1" ChargeDiagnosticElement : diagnostic
      ...
      IntegratedCurrentTransformer : electrical
        ...
        IntegratedCurrentTransformer --> "0..1" ElectricalElement : electrical
        click ElectricalElement href "../ElectricalElement/"
    

        
      IntegratedCurrentTransformer : hardware_class
        
          
    
        
        
        IntegratedCurrentTransformer --> "1" HardwareClassEnum : hardware_class
        click HardwareClassEnum href "../HardwareClassEnum/"
    

        
      IntegratedCurrentTransformer : hardware_model
        
      IntegratedCurrentTransformer : hardware_type
        
      IntegratedCurrentTransformer : inherits_from
      ...
      IntegratedCurrentTransformer : manufacturer
        ...
        IntegratedCurrentTransformer --> "0..1" ManufacturerElement : manufacturer
      ...
      IntegratedCurrentTransformer : physical
        ...
        IntegratedCurrentTransformer --> "0..1" PhysicalElement : physical
        click PhysicalElement href "../PhysicalElement/"
    

        
      IntegratedCurrentTransformer : reference
        
          
    
        
        
        IntegratedCurrentTransformer --> "0..1" ReferenceElement : reference
        click ReferenceElement href "../ReferenceElement/"
    

        
      IntegratedCurrentTransformer : simulation
        
          
    
        
        
        IntegratedCurrentTransformer --> "0..1" DiagnosticSimulationElement : simulation
...
| Property | Value |
| --- | --- |
| Class URI | [laura:IntegratedCurrentTransformer](https://w3id.org/laura/IntegratedCurrentTransformer) |
...
| ---  | ---  |
| self | laura:IntegratedCurrentTransformer |
| native | laura:IntegratedCurrentTransformer |
...
<details>
```yaml
name: IntegratedCurrentTransformer
description: Integrated current transformer (ICT) for non-destructive single-shot
  charge measurement.
