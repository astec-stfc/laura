...
def read_opal_field_file(
    ...
    """
    Read an OPAL field file and convert it into a :class:`nala.translator.utils.fields.field` object
    ...
    cavity_type: str, optional
        The type of RF cavity, see :attr:`~nala.translator.utils.fields.allowed_cavities`
